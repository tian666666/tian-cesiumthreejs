 ...
 * @LastEditTime: 2022-04-11 10:32:47
 * @LastEditors: TYW
 * @Description: 
-->
<template>
...
import { DRACOLoader } from "@/thirdparty/ThreeExamples/loaders/DRACOLoader.js";
import { ColladaLoader } from "@/thirdparty/ThreeExamples/loaders/ColladaLoader.js";
export default {
  name: "App",
  mounted() {
    function main() {
      ...
      function init3DObject(callback) {
        ...
        const loader = new GLTFLoader().setPath("models/gltf/"); // 'models/gltf/'
        ...
        const colladLoader = new ColladaLoader().setPath("models/collada/elf/");
        colladLoader.load("elf.dae", result => {
          const loadedMesh = result.scene.children[0].clone();
          ...
          const _3DOBC = new _3DObject();
          _3DOBC.threeMesh = loadedMesh;
          _3DOBC.minWGS84 = minWGS84;
          _3DOBC.maxWGS84 = maxWGS84;
          _3Dobjects.push(_3DOBC);
